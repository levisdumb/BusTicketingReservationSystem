   ...
   public void bookingTicketSelect() {
    ...
    if (firstName == null || lastName == null 
        ...
        if (!phoneNumber.matches(phoneRegex)) {
            ...
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Invalid phone number format. Please enter a valid phone number starting with 0 and containing 11 digits.");
            alert.showAndWait();
            return;
        }
        ...
        if (!firstName.matches(nameRegex)) {
            ...
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Invalid first name format. Please enter a valid first name containing only letters.");
            alert.showAndWait();
            return;
        }
        ...
        if (!lastName.matches(nameRegex)) {
            ...
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Invalid last name format. Please enter a valid last name containing only letters.");
            alert.showAndWait();
            return;
        }
    ...
    public void bookingTicketReceipt(){
        ...
        try{
            ...
            if(totalP > 0){
                ...
                JasperDesign jDesign = JRXmlLoader.load("C:\\Users\\QCU\\Documents\\NetBeansProjects\\busticketbookingmanagementsystem\\src\\busticketbookingmanagementsystem\\report2.jrxml");
    ...
    public void defaultBtn() {
        dashboard_Btn.setStyle("-fx-background-color: linear-gradient(to bottom, #374955, #222222)");
    ...
    public void switchForm(ActionEvent event) {
        ...
        if (event.getSource() == dashboard_Btn) {
            ...
            availableB_Btn.setStyle(" -fx-background-color: linear-gradient(to bottom, #374955, #222222)");
            ...
            bookingTicket_Btn.setStyle("-fx-background-color: linear-gradient(to bottom, #374955, #222222)");
            availableB_Btn.setStyle("-fx-background-color:transparent");
            dashboard_Btn.setStyle("-fx-background-color:transparent");
            customers_btn.setStyle("-fx-background-color:transparent");
            ...
            customers_btn.setStyle(" -fx-background-color: linear-gradient(to bottom, #374955, #222222)");
            availableB_Btn.setStyle("-fx-background-color:transparent");
            bookingTicket_Btn.setStyle("-fx-background-color:transparent");
            dashboard_Btn.setStyle("-fx-background-color:transparent");
